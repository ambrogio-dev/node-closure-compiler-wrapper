...
// Don't generate output. Run checks, but no compiler passes
// checks-only: false
                         
// Entry points to the program. Must be goog.provide'd symbols. Any goog.provi de'd symbols that are not a transitive
...
// jscomp_warning VAL                   : Make the named class of warnings a
                                          ...
                                          bers, uselessCode, useOfGoogBase,
                                          visibility. '*' adds all supported.
// json_streams [NONE | IN | OUT | BOTH]      : Specifies whether standard input and output streams will be a JSON array
